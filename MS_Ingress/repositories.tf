...
# NGINX "nginx-stable" Helm chart Reporsitory, defined as a data source
data "helm_repository" "nginx-stable" {
  name = "nginx-stable"
  url = "https://helm.nginx.com/stable"
}
# Contains NGINX Ingress Controller 1.7.0 (https://docs.nginx.com/nginx-ingress-controller/installation/installation-with-helm/)
